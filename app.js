...
middleDropdown.addEventListener('change', (e) => {
    ...
    // get the val  const value = e.target.value;
...
function displayStats() {
    reportEl.textContent = `You have changed heads ${headCounter} times, the middle ${middleCounter} times, the bottom ${bottomCounter} times`;
